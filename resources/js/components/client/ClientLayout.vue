        ...
        <aside class="client-sidebar" :class="{ 'client-sidebar--mobile-open': sidebarOpen }">
            ...
            <div class="client-sidebar__footer">
                <RouterLink :to="{ name: 'home' }"
                    class="client-sidebar__home-button essential-button essential-button--primary">
        ...
        <div class="client-main">
            <header class="client-header">
                ...
                <div class="client-header__profile">
                    <!-- Dark Mode Toggle -->
                    <div class="client-header__dark-mode-toggle">
                            ...
                            <div class="widget essential-switcher">
                                <div class="essential-switch">
                                    <input type="checkbox" name="switch" class="essential-switch-input"
                                        id="client-dark-mode-switch" :checked="!isDarkMode" @change="toggleDarkMode">
                                    <label class="essential-switch-label" for="client-dark-mode-switch">
                    ...
                    <button type="button" class="client-header__logout-button essential-button essential-button--ghost"
...
<script setup>
    ...
    const navItems = computed(() => ([
        ...
        { label: 'Mis Descargas', name: 'client.downloads', icon: 'pi-download' },
    ]));
...
<style scoped>
    ...
    .client-header__dark-mode-toggle {
        display: flex;
        align-items: center;
    }
