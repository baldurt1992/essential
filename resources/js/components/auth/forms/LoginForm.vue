    ...
    <form class="auth-form" @submit.prevent="handleSubmit">
        <div class="auth-form__field">
            ...
            <span class="auth-form__input-wrapper">
                <InputText id="login-email" v-model.trim="form.email" type="email" placeholder="tucorreo@dominio.com"
        ...
        <div class="auth-form__field">
            ...
            <span class="auth-form__input-wrapper">
                <Password id="login-password" v-model="form.password" toggle-mask :feedback="false"
                    autocomplete="current-password" class="auth-form__input w-full" input-class="auth-form__password-input"
        ...
        <div class="auth-form__recovery">
            <button type="button" class="auth-form__recovery-link" @click="$emit('recover-password')">
...
const emit = defineEmits(['submit', 'recover-password']);
