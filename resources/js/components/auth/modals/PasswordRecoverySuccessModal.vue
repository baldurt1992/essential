    ...
    <Dialog v-model:visible="localVisible" :modal="true" :draggable="false" :closable="false" dismissable-mask
        ...
        <template #header>
            <div class="success-modal__header">
                <h2 class="success-modal__title">¡Contraseña actualizada!</h2>
            </div>
        </template>

        <div class="success-modal">
            <div class="success-modal__content">
                <p class="success-modal__message">Tu contraseña ha sido actualizada exitosamente. Ahora puedes iniciar
                    sesión
        ...
        <template #footer>
            <Button type="button" class="success-modal__button essential-button--primary" label="Ir a iniciar sesión"
