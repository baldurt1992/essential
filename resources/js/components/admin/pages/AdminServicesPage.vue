<template>
    <section class="admin-page">
        ...
        <header class="admin-page__header">
            <div>
                <h2 class="admin-page__title">Servicios</h2>
                <p class="admin-page__subtitle">
                    Administra los servicios ofrecidos, controla su visibilidad en la landing y marca cuáles aparecen
                    como populares.
                </p>
            </div>
        ...
        <div class="admin-page__content">
            <div v-if="isLoading" class="admin-loader">
                ...
                <p class="admin-loader__text">Cargando servicios...</p>
            </div>

            <template v-else>
                <div class="admin-table__toolbar">
                    <div class="admin-table__meta">
                        <span class="admin-table__count">{{ pagination.total }} servicios registrados</span>
                        <span v-if="isRefreshing" class="admin-table__refresh">Actualizando…</span>
                    </div>
                </div>

                <div v-if="!services.length" class="admin-placeholder">
                    <span class="admin-placeholder__icon">
                        <i class="pi pi-list"></i>
                    </span>
                    <p class="admin-placeholder__text">
                        Aún no hay servicios cargados. Crea el primero para mostrarlos en la página principal.
                    </p>
                </div>
